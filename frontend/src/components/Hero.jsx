    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center text-white relative z-10">
        <div className="space-y-6 relative z-10">
          ...
          <div className="pt-4">
            <button className="bg-sport-dark text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-sport-neon hover:text-sport-dark transition-all transform hover:scale-105 shadow-lg">
              Găsește un Teren Acum
            </button>
          </div>
        </div>
        {/* Imaginea din dreapta a fost eliminată pentru a evidenția fundalul, la fel ca înainte */}
      </div>
    </div>
  )
}
